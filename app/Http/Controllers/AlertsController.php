...
class AlertsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $alerts->save();
        return redirect('/')->with('success','Alert has been added');
    ...
    public function update(Request $request, $id)
    {
        ...
        $alerts->update();
        return redirect('/alerts')->with('success','alert has been updated');
    ...
    public function destroy($id)
    {
        ...
        return redirect('/')->with('success', 'Alert has been Deleted');
    }
}
