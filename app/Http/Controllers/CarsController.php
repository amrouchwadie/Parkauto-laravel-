...
class CarsController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $carses->date = $request->date;
        $carses->update();
        return redirect('/cars')->with('success', 'la modification a éte bien effectuer');
    }
    ...
    public function updateop(Request $request, $id)
    {
        ...
        foreach ($request->id_alert as $key => $value) {
            if (!is_null($value)) {
                ...
                $carses->date = date_create($request->date[$key]);
                $carses->update();
                return redirect()->back()->with('success', 'operation a été bien modifier', compact('cars'));
            }
        }
    }
    ...
    public function createop($id)
    {
        ...
        $statuses = Status::get();
        $cars = Car::find($id);
        return view('cars.addopcar', compact('cars', 'statuses', 'alerts'));
    }
    public function storeop(Request $request, $id)
    {
