...
class EntretiensController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $entretiens->save();
        return redirect('/')->with('success','contract has been added');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $entretiens->update();
        return redirect('/entretiens')->with('success','entretien est mis a jour');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/entretiens')->with('success', 'entretien has been Deleted');
    }
}
