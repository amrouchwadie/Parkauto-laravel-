        ...
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                    ...
                    <select name="id_user" class="custom-select" id="id_user">                                
            ...
            <select name="id_car" class="custom-select" id="id_car">                                
                ...
                @endforeach
                       ...
                       <div class="form-group">
                            ...
                            <input type="date" class="form-control" placeholder="Date de debut Contrat" id="debut_contract"  name="debut_contract" value="{{$contracts->debut_contract}}">
                            <input type="hidden" name="_token" value="{{Session::token()}}">
                           
                        </div>
                        <div class="form-group">
                            <label for="end_contract"><b> Fin de Contrat*</b></label>
                            <input type="Date" placeholder="Fin de contrat " class="form-control" onblur="calcPrice()" id="end_contract" name="end_contract" value="{{$contracts->end_contract}}">
                        </div>
                        <div class="form-group">
                            <label for="price_day"><b> prix par jour*</b></label>
                            <input type="text" placeholder=" prix par jour " class="form-control" onblur="calcPrice()" id="price_day" name="price_day" value="{{$contracts->price_day}}">
                        </div>
                        <div class="form-group">
